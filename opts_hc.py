...
def parse_opt():
    ...
    parser.add_argument('--use_vc', action='store_true',
                        help='whether to use VC Feature')
    ...
    parser.add_argument('--caption_model', type=str, default="show_tell",
                    help='show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, adaattmo, topdown, stackatt, denseatt, transformer, HCCM')
    ...
    # HC
    parser.add_argument('--body_part_dir', type=str, default='/media/Disk2/yzpeng/HC_captioning/data/hc_img_body_part_att',
                        help='path to the npy containing the preprocessed dataset')
    parser.add_argument('--body_part_vc_dir', type=str,
                        default='/media/Disk2/yzpeng/HC_captioning/data/hc_img_body_part_att_vc',
                        help='path to the npy containing the preprocessed dataset')
    parser.add_argument('--part_mask_dir', type=str, default='/media/Disk2/yzpeng/HC_captioning/data/hc_part_mask',
                        help='path to the npy containing the preprocessed dataset')
    parser.add_argument('--eval_after', type=int, default=20,
                        help='language eval after')
    parser.add_argument('--att_drop_rate', type=float, default=0.2,
                        help='strength of drop in the Att Model')
...
def add_eval_options(parser):
    ...
    parser.add_argument('--part_mask_dir', type=str, default='/media/Disk2/yzpeng/HC_captioning/data/hc_part_mask',
                        help='path to the npy containing the preprocessed dataset')
    parser.add_argument('--att_drop_rate', type=float, default=0,
                        help='strength of drop in the Att Model')
