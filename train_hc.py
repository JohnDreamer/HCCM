...
import opts_hc as opts
import models
from dataloader_hc import *
import skimage.io
import eval_utils_hc as eval_utils
import misc.utils as utils
from misc.rewards import init_scorer, get_self_critical_reward
from misc.loss_wrapper_hc import LossWrapper
    ...
    try:
        while True:
            ...
            model_out = dp_lw_model(fc_feats, att_feats, labels, masks, att_masks, data['gts'],
                                    torch.arange(0, len(data['gts'])), sc_flag, body_feats, part_feats,
